...
class Game(object):
    ...
    def _get_last_N_timebars(self):
        print(f"Current index: {self.curr_idx}, Lookback: {self.lkbk}")
        ...
        if int(self.curr_idx) >= self.lkbk-1:
            ...
            print(f"30m bars padded shape: {self.last30m.shape}")
        ...
        if int(self.curr_idx) >= self.lkbk-1:
            ...
            print(f"4h bars padded shape: {self.last4h.shape}")
        ...
        if int(self.curr_idx) >= self.lkbk-1:
            ...
            print(f"1d bars padded shape: {self.last1d.shape}")

...
class Game(object):
    ...
    def _assemble_state(self):
        ...
        def _get_technical_indicators(bars):
            ...
            print("Head:", bars['close'].head())
            print("Tail:", bars['close'].tail())
            print("Any NaN?:", bars['close'].isnull().any())
            print("Values:", bars['close'].values)
            print("----------------------------\n")
            ...
            cci2 = talib.CCI(bars['high'], bars['low'], bars['close'], timeperiod=50); cci2_sma = talib.SMA(cci2, timeperiod=50)[-1]
            ...
            tech_ind = np.append(tech_ind, ribbon_signal); tech_ind = np.append(tech_ind, cci_signal)
            return tech_ind
...
def main():
    ...
    # try:
        ...
        print("\n------DEBUG df30m------")
        print("Type:", type(df30m))
        print("Shape:", df30m.shape if df30m is not None else None)
        print("Columns:", df30m.columns if df30m is not None else None)
        print("Head:\n", df30m.head() if df30m is not None else None)
        print("------------------------\n")

        print("------DEBUG df4h------")
        print("Type:", type(df4h))
        print("Shape:", df4h.shape if df4h is not None else None)
        print("Columns:", df4h.columns if df4h is not None else None)
        print("Head:\n", df4h.head() if df4h is not None else None)
        print("------------------------\n")

        print("------DEBUG df1d------")
        print("Type:", type(df1d))
        print("Shape:", df1d.shape if df1d is not None else None)
        print("Columns:", df1d.columns if df1d is not None else None)
        print("Head:\n", df1d.head() if df1d is not None else None)
        print("------------------------\n")
